...
if (senderName) {
  ...
  let prompt = `Rewrite the original feedback in English.make you are like sender name sender name views,rewrite with clear,polite but not loss emotion,${personalization}`;
